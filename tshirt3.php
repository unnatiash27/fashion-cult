...
<html lang="en">
  ...
  <body>
    ...
    <div class="small-container single-product">
      ...
      <div class="row">
        <div class="col-2">
          <img src="tshirt3a.PNG" width="100%" id="productImg" />
        ...
        <div class="col-2">
          <p>Home / Cloths</p>
          <h1>Puma Cotton Regular Fit Mens T-Shirt</h1>
          <h4> 2,299</h4>
          <select>
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="Puma tshirt">
