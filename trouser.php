...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="trouser2I.PNG" width="100%" id="productImg" />
        ...
        <div class="col-2">
          <p>Home / Cloths</p>
          <h1>Slim Fit Cotton Rich Stretch Cargo Trousers</h1>
          <h4> ₹1,740</h4>
          <select>
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="Cargo Trousers">
          <input type="hidden" name="Price" value="1740">
          <h3>Product Details <i class="fa fa-indent"></i></h3>
          <br />
          <p>These cotton-rich cargo trousers from our Autograph range effortlessly balance smart and casual. They're cut to a streamlined slim fit and feature added stretch for that extra bit of comfort. Flap pockets on both legs provide an authentic style.</p>
        </div>
      </div>
      </form>
    </div>
