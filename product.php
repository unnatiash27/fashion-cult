...
<html lang="en">
  ...
  <body>
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="red tshirt">
          <input type="hidden" name="Price" value="900">
          <h3>Product Details <i class="fa fa-indent"></i></h3>
          <br />
          <p>
            Traditionally, it has short sleeves and a round neckline, known as a
            crew neck, which lacks a collar. T-shirts are generally made of a
            stretchy, light, and inexpensive fabric and are easy to clean.
           </p>
        </div>
        </div>
      </form>
