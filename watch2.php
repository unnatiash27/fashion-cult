...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="product-8.jpg" width="100%" id="productImg" />
        ...
        <div class="col-2">
          <p>Home / watch</p>
          <h1>The Minimalist Two-Hand Black  Watch
</h1>
          <h4>₹ 9,495</h4>
          <select>
    ...
    height: 42px;">Add to cart</button>
           <input type="hidden" name="Item_Name" value="Minimalist Watch">
