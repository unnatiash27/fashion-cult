...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="trouser3a.PNG" width="100%" id="productImg" />
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="Black Nike Trousers">
          <input type="hidden" name="Price" value="1247">
          <h3>Product Details <i class="fa fa-indent"></i></h3>
          <br />The Nike Dri-FIT Academy Pants feature sweat-wicking fabric to help keep you dry and moving fast on the field. Tapered legs keep your feet clear on the ball, while zippered hems let you change quickly over cleats or shoes. This product is made with 100% recycled polyester fibers.</p>
        </div>
      </div>
      </form>
    </div>
    ...
    <div class="small-container">
      <div class="row">
        <div class="col-4">
          ...
          <a href="watch1.php"><h4>Roadster Wrist Watch</h4>
          <div class="rating"></a>
