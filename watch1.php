...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="watch1a.jpg" width="100%" id="productImg" />
...
<br />
Features: Multi Function, Date Aperture, Reset Time
<br />
Strap style: Black regular, synthetic strap with a tang closure
<br />
Water resistance: Water Resistant
<br />
Mock chronograph and side buttons
Comes in a signature Roadster box
          </p>
        </div>
      </div>
      </form>
