...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="shoes3.PNG" width="100%" id="productImg" />
        ...
        <div class="col-2">
          <p>Home / Shoes</p>
          <h1>Vostro Men Light Grey Sport Shoes</h1>
          <h4>₹850</h4>
          <select>
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="Grey Sport Shoes">
...
Model- Name/Number	Oreo
</br>

Color-	Grey
</br>
Usage/Application-	Sports Wear
</br>
Sole Material-	PU(polyurethane) Sole
</br>
Closure-	Lace-Up
</br>
Packaging Type-	Box
