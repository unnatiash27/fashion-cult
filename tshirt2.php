...
<html lang="en">
  ...
  <body>
    ...
    <div class="small-container single-product">
      ...
      <div class="row">
        <div class="col-2">
          <img src="tshirt2.PNG" width="100%" id="productImg" />
        ...
        <div class="col-2">
          <p>Home / Cloths</p>
          <h1>Puma
Men Black & Blue Brand Logo Printed Slim Fit Cotton T-shirt</h1>
          <h4>₹629</h4>
          <select>
    ...
    height: 42px;">Add to cart</button>
          <input type="hidden" name="Item_Name" value="Cotton T-shirt">
          <input type="hidden" name="Price" value="629">
          <h3>Product Details <i class="fa fa-indent"></i></h3>
          <br />
          <p>Black and blue Tshirt for men
Brand logo printed
Regular length
Round neck
