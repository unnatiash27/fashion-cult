...
<html lang="en">
  ...
  <body>
    ...
    <form action="manage_cart.php" method="POST">
      <div class="row">
        <div class="col-2">
          <img src="product2aI.jpg" width="100%" id="productImg" />
...
Constructed with knitted fabric
TPU/ Plastic panel around the girth of the shoe provides support from the sides and more snug fit. 
          </p>
        </div>
      </div>
      </form>
